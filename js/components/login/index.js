    ...
    render() {
        ...
        return (
            <View style={styles.container}>
                <ImageBackground
                    source={{uri:'https://github.com/react-native-training/react-native-elements-app/blob/master/assets/images/bg_screen4.jpg?raw=true'}}
                            ...
                            <KeyboardAvoidingView contentContainerStyle={styles.loginContainer} behavior='position'>
                                <View style={styles.titleContainer}>
                                    <View style={{flexDirection: 'row'}}>
                                        <Text style={styles.titleText}>Bookliked</Text>
                                    </View>
                                </View>
                                <View style={{flexDirection: 'row'}}>
                                    <Button
                                ...
                                <View style={styles.formContainer}>
                                    ...
                                    <Input
                                        ...
                                        errorMessage={isConfirmationValid ? null : 'Пожалуйста введите пароль'}
                                    />}
                                    <Button
                                        buttonStyle={styles.loginButton}
                                        containerStyle={{marginTop: 32, flex: 0}}
                                        activeOpacity={0.8}
                                        title={isLoginPage ? 'Войти' : 'Зарегистрироваться'}
